...
for i in range(20):
    for j in range(17):
        product = int(grid[i][j]) * int(grid[i][j+1]) * int(grid[i][j+2]) \
            * int(grid[i][j+3])
...
for i in range(17):
    for j in range(20):
        product = int(grid[i][j]) * int(grid[i+1][j]) * int(grid[i+2][j]) \
            * int(grid[i+3][j])
        if product > max_product:
            max_product = product
...
for i in range(17):
    for j in range(17):
        product = int(grid[i][j]) * int(grid[i+1][j+1]) * int(grid[i+2][j+2]) \
            * int(grid[i+3][j+3])
        if product > max_product:
            max_product = product
